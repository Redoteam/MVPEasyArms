 ...
 */
package com.yl.core.http.imageloader.glide;
...
import com.yl.core.http.OkHttpUrlLoader;
...
//        final AppComponent appComponent = ArmsUtils.obtainAppComponentFromContext(context);
        ...
        builder.setDiskCache(new DiskCache.Factory() {
            ...
            public DiskCache build() {
                ...
                return DiskLruCacheWrapper.create(DataHelper.makeDirs(new File(appDelegate.provideCacheFile(), "Glide")), IMAGE_DISK_CACHE_MAX_SIZE);
            }
        });
        ...
        BaseImageLoaderStrategy loadImgStrategy = appDelegate.provideImageLoader().getLoadImgStrategy();
...
//        AppComponent appComponent = ArmsUtils.obtainAppComponentFromContext(context);
        OkHttpClient okHttpClient = AppDelegate.getInstance().provideOkHttpClient();
