...
import com.yl.acoreui.utils.UrlUtils;
 ...
 */
public class CommentListView<U extends IUser, T extends IComment<U>> extends LinearLayout {
    ...
    private View getView(final int position) {
        ...
        View convertView = layoutInflater.inflate(R.layout.item_coreui_comment, null, false);
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor) {
            ...
            public void onClick(View widget) {
                Toast.makeText(AppDelegate.getInstance().getmApplication(), textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
            }
