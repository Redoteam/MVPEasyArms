package com.yl.acoreui.weight.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod() {
        ...
        this.textViewBgColor = application.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = application.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
